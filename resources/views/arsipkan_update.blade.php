    ...
    <div class="animated fadeIn">
        ...
        <div class="col-lg">
            <div class="card">
                ...
                <div class="card-body">
                     <form method="POST" action="{{route('storeArsipUpdate',$id)}}" enctype="multipart/form-data" id="formEdit">
                        @csrf
                        @method('patch')
                    <div class="row form-group">
                        <div class="col col-md-2"><label for="text-input" class=" form-control-label">Nomor Surat</label></div>
                        <div class="col-12 col col-md-4"><input type="text" id="nomor_surat" name="nomor_surat" value="{{$arsip->nomor_surat}}" class="form-control"></div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col col-md-2">
                          <select name="kategori" id="kategori" class="form-control">
                            <option value="undangan" {{ "undangan" == $arsip->kategori ? 'selected' : '' }}>Undangan</option>
                            <option value="rapat" {{ "rapat" == $arsip->kategori ? 'selected' : '' }}>Rapat</option>
                            <option value="pengumuman" {{ "pengumuman" == $arsip->kategori ? 'selected' : '' }}>Pengumuman</option>
                            <option value="administrasi" {{ "administrasi" == $arsip->kategori ? 'selected' : '' }}>Administrasi</option>
                          </select>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col col-md-8"><input type="text" id="judul" name="judul" placeholder="Judul" value="{{$arsip->judul}}" class="form-control"></div>
                    </div>
